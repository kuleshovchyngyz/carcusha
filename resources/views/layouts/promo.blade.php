        ...
        <form action="{{ route('user.promo') }}" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="main__setting-item">
                        <div>Названия компании:
                            <input type="text" id="company" name="company" class="form-control" placeholder="Не указан"
                                   value="@if(Auth::user()->promo!==null){{ Auth::user()->promo->name }} @endif">
                        </div>
                ...
                <div class="col-md-6">
                    <div class="main__setting-item">
                        <div>Телефон:
                            <input type="text" id="number" name="number" class="form-control" placeholder="Не указан"
                                   value="{{ ViewService::init()->view('promo_number') }}">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="main__setting-item">
                        <div>E-Mail:
                            <input type="text" id="email" name="email" class="form-control" placeholder="Не указан"
                                   value="@if(Auth::user()->promo===null){{ Auth::user()->setting->email }}@else {{ Auth::user()->promo->email }} @endif">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="main__setting-item">
                        <div>Адрес:
                            <input type="text" id="address" name="address" class="form-control" placeholder="Не указан"
                                   value="@if(Auth::user()->promo!==null){{ Auth::user()->promo->address }} @endif">
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row no-gutters mt-5">
                ...
                <div class="col-md-6 d-flex">
                    <div class="ml-auto mr-auto">
                        <h3>Плакаты</h3>
                        <img src="{{ asset('qrcodes/card_qr_'.\auth()->user()->id.'.png') }}" class="img-promo" alt=""
                             style="
    max-width: 361px;">

    ...
    <div class="main__content">
        ...
        <div class="table-responsive">
            <table class="main__table">
                <thead>
                <tr>
                    <th><a class="no-decor-link"
                           href="{{ route('admin.user',$user->id) }}@if($sort!='')?sort={{ $sort }}@endif">Номер</a>
                    </th>
                    <th>Автомобиль</th>
                    <th>Телефон</th>
                    <th>Статус</th>
                ...
                @foreach($leads as $lead)
                    @if($lead!=false)
                        <tr>
                            <td>#{{ $lead->bitrix_lead_id }}  @if($lead->checked())  <img
                                    src="{{ asset('img/unchecked.png') }}" alt=""> @endif</td>
                            ...
                            @else
                                ...
                                {{--                                @dump($lead->history())--}}
                                {{--                                @dump($lead)--}}
                                <td class="main__table-dd-wrap"
                                    style="color:{{ $lead->status->color }};">{{ $lead->status->name }}
